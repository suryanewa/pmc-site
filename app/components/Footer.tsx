      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex gap-24">
          ...
          <div className="flex flex-col gap-2">
            ...
            <a href="/people/community" className={`${textMutedColor} ${textHoverColor} transition-colors`}>/community</a>
            <a href="/people/leadership" className={`${textMutedColor} ${textHoverColor} transition-colors`}>/leadership</a>
            <a href="/people/alumni" className={`${textMutedColor} ${textHoverColor} transition-colors`}>/alumni</a>
          </div>
