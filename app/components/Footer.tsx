...
export function Footer() {
  return (
    <footer className="bg-[#1a1a1a] px-[52px] py-12">
      <div className="flex items-start justify-between">
        {/* Logo */}
        <div className="flex items-center gap-[2px]">
          <span className="text-[33px] font-medium tracking-tight text-white">eeg</span>
          <span className="text-[39px] font-medium text-[#0115DF]">/</span>
        </div>
