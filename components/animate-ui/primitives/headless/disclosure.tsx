...
type DisclosureBag = Parameters<
  Exclude<NonNullable<DisclosurePrimitiveProps<'div'>['children']>, React.ReactNode>
>[0];

type DisclosureButtonBag = Parameters<
  Exclude<
    NonNullable<DisclosureButtonPrimitiveProps<'button'>['children']>,
    React.ReactNode
  >
>[0];

type DisclosurePanelBag = Parameters<
  Exclude<NonNullable<DisclosurePanelPrimitiveProps<'div'>['children']>, React.ReactNode>
>[0];
...
export {
  ...
  useDisclosure,
  type DisclosureBag,
  type DisclosureButtonBag,
  type DisclosurePanelBag,
